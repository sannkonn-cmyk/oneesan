@echo off
rem ---------------------------------------------------------------
rem Registers this app with Claude Desktop / Claude Code so they can
rem read its data directly (read-only, over stdio, no network).
rem
...
rem Japanese guidance is printed from Node (scripts/mcp-setup.mjs).
rem ---------------------------------------------------------------
setlocal
chcp 65001 >nul 2>nul
cd /d "%~dp0"
title Oneesan - Claude setup
